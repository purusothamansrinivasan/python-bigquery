...
func Bigquery_routines_insertHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/projects/%s/datasets/%s/routines%s", cfg.BaseURL, projectId, datasetId, queryString)
...
func CreateBigquery_routines_insertTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_projects_projectId_datasets_datasetId_routines",
		mcp.WithDescription("Creates a new routine in the dataset."),
		mcp.WithString("projectId", mcp.Required(), mcp.Description("Required. Project ID of the new routine")),
		mcp.WithString("datasetId", mcp.Required(), mcp.Description("Required. Dataset ID of the new routine")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Bigquery_routines_insertHandler(cfg),
	}
}
