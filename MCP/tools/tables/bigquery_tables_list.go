...
func Bigquery_tables_listHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/projects/%s/datasets/%s/tables%s", cfg.BaseURL, projectId, datasetId, queryString)
...
func CreateBigquery_tables_listTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_projects_projectId_datasets_datasetId_tables",
		mcp.WithDescription("Lists all tables in the specified dataset. Requires the READER dataset role."),
		mcp.WithString("projectId", mcp.Required(), mcp.Description("Required. Project ID of the tables to list")),
		mcp.WithString("datasetId", mcp.Required(), mcp.Description("Required. Dataset ID of the tables to list")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Bigquery_tables_listHandler(cfg),
	}
}
