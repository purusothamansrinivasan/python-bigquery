...
func Bigquery_tables_getiampolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GetIamPolicyRequest
		...
		url := fmt.Sprintf("%s/%s:getIamPolicy%s", cfg.BaseURL, resource, queryString)
...
func CreateBigquery_tables_getiampolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_resource:getIamPolicy",
		...
		mcp.WithObject("options", mcp.Description("Input parameter: Encapsulates settings provided to GetIamPolicy.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Bigquery_tables_getiampolicyHandler(cfg),
	}
}
